...
class GeneratorService:
    ...
    def _build_code_parts(
        ...
        return CodeParts(
            ...
            component_code=pattern_structure.code,
            storybook_stories=self._generate_basic_story(component_name),
            component_name=component_name
        )
    
    def _generate_provenance_header(self) -> str:
        """Generate basic provenance header (full implementation in P1)."""
        import datetime
 ...
 * Generated: {timestamp}
 * DO NOT EDIT: Regenerate with ComponentForge instead
 */"""
